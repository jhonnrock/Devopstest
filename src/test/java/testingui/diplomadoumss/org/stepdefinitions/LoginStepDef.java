...
public class LoginStepDef {
    ...
    @And("^Click 'Register' link on 'Left Panel' Page$")
    public void clickRegisterLinkOnLeftPanelPage() {
        dashboard.clickExtrasLinksIntoHotelsOptions();
    }

    @And("^I validation of fields 'Add Conctactos' Page$")
    public void iValidationOfFieldsAddConctactosPage() {
        dashboard.fillTheFields();
    }
}